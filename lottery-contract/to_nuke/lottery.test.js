...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.crystal = await MockBEP20.deployed();
        ...
        await this.crystal.transfer(bob, '2000', { from: minter });
        await this.crystal.transfer(alice, '2000', { from: minter });
        await this.crystal.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.crystal.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.crystal.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.crystal.balanceOf(this.lotteryProxyAddress)).toString(), '418');
        ...
        // console.log('crystal2:', (await this.crystal.balanceOf(alice, {from: alice})).toString());
