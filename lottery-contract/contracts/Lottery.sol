...
contract Lottery is Ownable, Initializable, Testable {
    ...
    struct LottoInfo {
        ...
        uint256 prizePoolInCake;    // The amount of crystal for prize money
        uint256 costPerTicket;      // Cost per ticket in $crystal
        ...
        notContract()
    {
        ...
        // Transfers the required crystal to this contract
        crystal_.transferFrom(
            msg.sender, 
            address(this), 
            costWithDiscount
        );
    ...
    function claimReward(uint256 _lotteryId, uint256 _tokenId) external notContract() {
        ...
        crystal_.safeTransfer(address(msg.sender), prizeAmount);
    }
        ...
        notContract()
    {
        ...
        crystal_.safeTransfer(address(msg.sender), totalPrize);
    }
     ...
     * @return  uint256: The prize amount in crystal the user is entitled to 
     */
