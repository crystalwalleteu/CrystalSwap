/**
 * @see https://github.com/crystalswap/crystal-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  crystal: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://crystalswap.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://crystalbunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
