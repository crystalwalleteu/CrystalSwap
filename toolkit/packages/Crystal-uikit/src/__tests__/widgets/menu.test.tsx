...
it("renders correctly", () => {
  const { asFragment } = renderWithTheme(
    <BrowserRouter>
      <Menu
        ...
        setLang={noop}
        currentLang="en-US"
        crystalPriceUsd={0.23158668932877668}
        links={menuConfig}
      >
        body
      </Menu>
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c3:hover:not(:disabled):not(.crystal-button--disabled):not(.crystal-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c3:active:not(:disabled):not(.crystal-button--disabled):not(.crystal-button--disabled) {
      opacity: 0.85;
    ...
    .c23:hover:not(:disabled):not(.crystal-button--disabled):not(.crystal-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c23:active:not(:disabled):not(.crystal-button--disabled):not(.crystal-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              aria-label="Pancrystal home page"
              class="c6"
              href="/"
            >
              <svg
