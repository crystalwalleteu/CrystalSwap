...
import chaoticCakersSm from "./teams/chaotic-crystalrs-sm.png";
import chaoticCakersMd from "./teams/chaotic-crystalrs-md.png";
import chaoticCakersLg from "./teams/chaotic-crystalrs-lg.png";
import chaoticCakersAlt from "./teams/chaotic-crystalrs-alt.png";
import chaoticCakersBg from "./teams/chaotic-crystalrs-bg.svg";
...
const teamImages: ImageMap = {
  ...
  "chaotic-crystalrs-sm.png": chaoticCakersSm,
  "chaotic-crystalrs-md.png": chaoticCakersMd,
  "chaotic-crystalrs-lg.png": chaoticCakersLg,
  "chaotic-crystalrs-alt.png": chaoticCakersAlt,
  "chaotic-crystalrs-bg.svg": chaoticCakersBg,
};
