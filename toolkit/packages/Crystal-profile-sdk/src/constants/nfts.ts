...
const Nfts: Nft[] = [
  ...
  },
  {
    ...
    images: {
      lg: "crystalston-easter-21-lg.png",
      md: "crystalston-easter-21-md.png",
      sm: "crystalston-easter-21-sm.png",
      ipfs: `${IPFS_GATEWAY}/ipfs/QmZGqWaovULNEMKxBCGnGjh27JQkAyadS6AW4J4Lzf3XBp/easter-crystalr.png`,
    },
    sortOrder: 999,
    identifier: "easter-crystalr",
    type: NftType.PANCAKE,
    variationId: 15,
  },
  {
  ...
  {
    name: "Sunny",
    description: "Sunny is always cheerful when there are crystals around. Smile!",
    images: {
      lg: "sunny-lg.png",
      md: "sunny-md.png",
      sm: "sunny-sm.png",
  ...
  {
    name: "Blueberries",
    description: "These bunnies like their crystals with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: "Circular",
    description: "Love makes the world go 'round... but so do crystals. And these bunnies know it.",
    images: {
      lg: "circular-lg.png",
      md: "circular-md.png",
      sm: "circular-sm.png",
  ...
  {
    name: "Sparkle",
    description: "It’s sparkling syrup, crystals, and even lottery tickets! This bunny really loves it.",
    images: {
      lg: "sparkle-lg.png",
      md: "sparkle-md.png",
      sm: "sparkle-sm.png",
