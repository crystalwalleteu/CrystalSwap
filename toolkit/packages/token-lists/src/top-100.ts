...
/**
 * Fetch Top100 Tokens traded on CrystalSwap v2, ordered by trading volume,
...
const main = async (): Promise<void> => {
  try {
    ...
    const tokenListPath = `${path.resolve()}/src/tokens/crystalswap-top-100.json`;
