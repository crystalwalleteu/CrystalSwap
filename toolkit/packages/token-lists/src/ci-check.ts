import srcDefault from "./tokens/crystalswap-default.json";
import srcExtended from "./tokens/crystalswap-extended.json";
import srcTop100 from "./tokens/crystalswap-top-100.json";
import srcTop15 from "./tokens/crystalswap-top-15.json";
import defaultList from "../lists/crystalswap-default.json";
import extendedtList from "../lists/crystalswap-extended.json";
import top15List from "../lists/crystalswap-top-15.json";
import top100tList from "../lists/crystalswap-top-100.json";
